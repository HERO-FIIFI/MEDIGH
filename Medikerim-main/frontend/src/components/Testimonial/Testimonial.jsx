...
import patientAvatar4 from '../../assets/images/femake doctor22.jpg'
    ...
    return (
        <div className='mt-[30px] lg:mt-[55px]'>
            ...
            <Swiper modules={[Pagination]} spaceBetween={30} slidesPerView={1} pagination={{ clickable: true }} breakpoints={{
                ...
                <SwiperSlide>
                    <div className='py-[30px] px-5 rounded-[13px] glass-card'>
                        <div className='flex items-center gap-[13px]'>
                            <img src={patientAvatar1} alt="Photo of Kwame Mensah" width="100" height="100" className="rounded-full object-cover" />
                ...
                <SwiperSlide>
                    <div className='py-[30px] px-5 rounded-[13px] glass-card'>
                        <div className='flex items-center gap-[13px]'>
                            <img src={patientAvatar2} alt="Photo of Chidi Okonkwo" width="100" height="100" className="rounded-full object-cover" />
                ...
                <SwiperSlide>
                    <div className='py-[30px] px-5 rounded-[13px] glass-card'>
                        <div className='flex items-center gap-[13px]'>
                            <img src={patientAvatar3} alt="Photo of Jamal Williams" width="100" height="100" className="rounded-full object-cover" />
                ...
                <SwiperSlide>
                    <div className='py-[30px] px-5 rounded-[13px] glass-card'>
                        <div className='flex items-center gap-[13px]'>
                            <img src={patientAvatar4} alt="Photo of Aisha Mohammed" width="100" height="100" className="rounded-full object-cover" />
                            <div className='text-[18px] leading-[30px] font-semibold text-headingColor '><h4>Aisha Mohammed</h4>
                                <div className='flex items-center gap-[2px]'>
                                    <HiStar className='text-yellowColor w-[18px] h-5' />
                                    <HiStar className='text-yellowColor w-[18px] h-5' />
                                    <HiStar className='text-yellowColor w-[18px] h-5' />
                        ...
                        <p className='text-[16px] leading-7 mt-4 text-textColor font-[400]'>"The mobile app made managing my appointments so convenient. Great experience from start to finish!"</p>
                    </div>
                </SwiperSlide>
            </Swiper>
        </div>
